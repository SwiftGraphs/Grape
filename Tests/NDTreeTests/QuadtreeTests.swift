...
final class DummyQuadtreeDelegate: NDTreeDelegate {
...
//        var del = DummyQuadtreeDelegate()
    ...
    func testCreatePoint() {
        ...
        q.add(2, at: [0.9, 0.0])
        assert(
            q.debugDescription ~= "[{data: [0.0, 0.0]}, {data: [0.9, 0.0]},, {data: [0.9, 0.9]}]")

        q.add(3, at: [0.0, 0.9])
        assert(
            q.debugDescription
                ~= "[{data: [0.0, 0.0]}, {data: [0.9, 0.0]}, {data: [0.0, 0.9]}, {data: [0.9, 0.9]}]"
        )

        q.add(4, at: [0.4, 0.4])
        assert(
            q.debugDescription
                ~= "[[{data: [0.0, 0.0]},,, {data: [0.4, 0.4]}], {data: [0.9, 0.0]}, {data: [0.0, 0.9]}, {data: [0.9, 0.9]}]"
        )
    }
