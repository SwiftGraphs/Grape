...
extension Simulation2D {
    ...
    final public class CenterForce2D: ForceLike
    ...
    @discardableResult
    public func createCenterForce(center: V, strength: V.Scalar = 0.1) -> CenterForce2D {
        let f = CenterForce2D(center: center, strength: strength)
        f.simulation = self
