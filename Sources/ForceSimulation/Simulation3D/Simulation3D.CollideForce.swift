...
//
    ...
    public struct MaxRadiusTreeDelegate3D<NodeID>: OctreeDelegate where NodeID: Hashable {
        ...
        @inlinable
        public func copy() -> MaxRadiusTreeDelegate3D {
            return Self(maxNodeRadius: maxNodeRadius, radiusProvider: radiusProvider)
        }

        @inlinable
        public func spawn() -> MaxRadiusTreeDelegate3D {
            return Self(radiusProvider: radiusProvider)
        }

        @inlinable
        public init(maxNodeRadius: V.Scalar = 0, radiusProvider: @escaping (NodeID) -> V.Scalar) {
